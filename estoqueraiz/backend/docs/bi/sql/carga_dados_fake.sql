-- Carga fake para ambiente de desenvolvimento
-- ATENCAO: este script remove dados das tabelas de origem abaixo.
-- Tabelas afetadas: categorias, unidades, usuarios, produtos, movimentacoes
