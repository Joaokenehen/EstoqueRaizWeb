...
describe('Página de Cadastro', () => {
  ...
  context('Testes de Validação', () => {
    ...
    context('Senha', () => {
      ...
      it('Deve rejeitar senhas que não coincidem', () => {
        ...
        cy.get('[input-testid="cpf-input"]').type(gerarCpfValido());
      ...
      it('Deve rejeitar senha com menos de 6 caracteres', () => {
        ...
        cy.get('[input-testid="email-input"]').type(`senha_curta_${Date.now()}@test.com`);
        cy.get('[input-testid="cpf-input"]').type(gerarCpfValido());
      ...
      it('Deve rejeitar senha sem letra maiúscula', () => {
        ...
        cy.get('[input-testid="email-input"]').type(`sem_maiuscula_${Date.now()}@test.com`);
        cy.get('[input-testid="cpf-input"]').type(gerarCpfValido());
        cy.get('[input-testid="senha-input"]').type('senha123');
        cy.get('[input-testid="confirmar-senha-input"]').type('senha123');
        cy.get('[input-testid="btn-finalizar-cadastro"]').click();
      ...
      it('Deve rejeitar senha sem número', () => {
        ...
        cy.get('[input-testid="email-input"]').type(`sem_numero_${Date.now()}@test.com`);
        cy.get('[input-testid="cpf-input"]').type(gerarCpfValido());
    ...
    context('CPF', () => {
      ...
      it('Deve rejeitar CPF com formato inválido', () => {
        cy.get('[input-testid="nome-input"]').type('Usuario CPF Invalido');
        cy.get('[input-testid="email-input"]').type(`cpf_invalido_${Date.now()}@test.com`);
        cy.get('[input-testid="cpf-input"]').type('00000000000');
        cy.get('[input-testid="senha-input"]').type('Senha123!');
        cy.get('[input-testid="confirmar-senha-input"]').type('Senha123!');
        cy.get('[input-testid="btn-finalizar-cadastro"]').click();
      ...
      it('Deve rejeitar CPF com menos de 11 dígitos', () => {
        cy.get('[input-testid="nome-input"]').type('Usuario CPF Curto');
        cy.get('[input-testid="email-input"]').type(`cpf_curto_${Date.now()}@test.com`);
        cy.get('[input-testid="cpf-input"]').type('1234567');
        cy.get('[input-testid="senha-input"]').type('Senha123!');
        cy.get('[input-testid="confirmar-senha-input"]').type('Senha123!');
        cy.get('[input-testid="btn-finalizar-cadastro"]').click();
    ...
    context('Campos Obrigatórios', () => {
      ...
      it('Deve impedir o envio com o campo Nome vazio', () => {
        cy.get('[input-testid="email-input"]').type(`nome_vazio_${Date.now()}@test.com`);
        cy.get('[input-testid="cpf-input"]').type(gerarCpfValido());
        cy.get('[input-testid="senha-input"]').type('Senha123!');
        cy.get('[input-testid="confirmar-senha-input"]').type('Senha123!');
        cy.get('[input-testid="btn-finalizar-cadastro"]').click();

        cy.get('[input-testid="mensagem-feedback"]').should('not.exist');
        cy.get('[input-testid="nome-input"]').then(($el) => {
          expect(($el[0] as HTMLInputElement).validity.valid).to.be.false;
        });
      });

      it('Deve impedir o envio com o campo E-mail vazio', () => {
        cy.get('[input-testid="nome-input"]').type('Usuario Sem Email');
        cy.get('[input-testid="cpf-input"]').type(gerarCpfValido());
        cy.get('[input-testid="senha-input"]').type('Senha123!');
        cy.get('[input-testid="confirmar-senha-input"]').type('Senha123!');
        cy.get('[input-testid="btn-finalizar-cadastro"]').click();
        ...
        cy.get('[input-testid="mensagem-feedback"]').should('not.exist');
        cy.get('[input-testid="email-input"]').then(($el) => {
          expect(($el[0] as HTMLInputElement).validity.valid).to.be.false;
        });
      });

      it('Deve impedir o envio com o campo CPF vazio', () => {
        cy.get('[input-testid="nome-input"]').type('Usuario Sem CPF');
        cy.get('[input-testid="email-input"]').type(`sem_cpf_${Date.now()}@test.com`);
        cy.get('[input-testid="senha-input"]').type('Senha123!');
        cy.get('[input-testid="confirmar-senha-input"]').type('Senha123!');
        cy.get('[input-testid="btn-finalizar-cadastro"]').click();

        cy.get('[input-testid="mensagem-feedback"]').should('not.exist');
        cy.get('[input-testid="cpf-input"]').then(($el) => {
          expect(($el[0] as HTMLInputElement).validity.valid).to.be.false;
        });
      });

      it('Deve impedir o envio com o campo Senha vazio', () => {
        cy.get('[input-testid="nome-input"]').type('Usuario Sem Senha');
        cy.get('[input-testid="email-input"]').type(`sem_senha_${Date.now()}@test.com`);
        cy.get('[input-testid="cpf-input"]').type(gerarCpfValido());
        cy.get('[input-testid="confirmar-senha-input"]').type('Senha123!');
        cy.get('[input-testid="btn-finalizar-cadastro"]').click();

        cy.get('[input-testid="mensagem-feedback"]').should('not.exist');
        cy.get('[input-testid="senha-input"]').then(($el) => {
          expect(($el[0] as HTMLInputElement).validity.valid).to.be.false;
        });
      });

      it('Deve rejeitar e-mail com formato inválido', () => {
        cy.get('[input-testid="nome-input"]').type('Usuario Email Invalido');
        cy.get('[input-testid="email-input"]')
  ...
  context('Limitadores de Caracteres (maxLength)', () => {
    ...
    it('Deve limitar o campo Nome a 100 caracteres', () => {
      cy.get('[input-testid="nome-input"]').type('A'.repeat(120));
    ...
    it('Deve limitar o campo E-mail a 100 caracteres', () => {
      ...
      cy.get('[input-testid="email-input"]').type(emailAlem);
    ...
    it('Deve limitar o campo CPF a 11 dígitos', () => {
      cy.get('[input-testid="cpf-input"]').type('1'.repeat(20));
    ...
    it('Deve limitar o campo Senha a 32 caracteres', () => {
      cy.get('[input-testid="senha-input"]').type('Senha123!'.repeat(10));
    ...
    it('Deve limitar o campo Confirmar Senha a 32 caracteres', () => {
      cy.get('[input-testid="confirmar-senha-input"]').type('Senha123!'.repeat(10));

      cy.get('[input-testid="confirmar-senha-input"]').then(($el) => {
        expect(($el[0] as HTMLInputElement).value).to.have.length(32);
      });
    });
  });
